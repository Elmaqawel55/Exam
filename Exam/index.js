...
//------------------------>display categories meals details <----------------------------------------//
...
function showContacts() {
    colsData.innerHTML = `<div class="contact min-vh-100 d-flex justify-content-center align-items-center">
